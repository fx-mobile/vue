(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "axios", "@ttk/vue-ui", "../application", "./auth"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("axios"), require("@ttk/vue-ui"), require("../application"), require("./auth"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.axios, global.vueUi, global.application, global.auth);
    global.request = mod.exports;
  }
})(this, function (_exports, _axios, _vueUi, _application, _auth) {
  "use strict";
