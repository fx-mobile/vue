(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "@babel/runtime/helpers/defineProperty", "vue", "vuex", "../packages/App", "./router", "./store", "./store/getters", "tax-group-ui"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("@babel/runtime/helpers/defineProperty"), require("vue"), require("vuex"), require("../packages/App"), require("./router"), require("./store"), require("./store/getters"), require("tax-group-ui"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.defineProperty, global.vue, global.vuex, global.App, global.router, global.store, global.getters, global.taxGroupUi);
    global.application = mod.exports;
  }
})(this, function (_exports, _defineProperty2, _vue, _vuex, _App, _router, _store, _getters, _taxGroupUi) {
  "use strict";
  ...
  _taxGroupUi = _interopRequireDefault(_taxGroupUi);
  ...
  _vue.default.use(_taxGroupUi.default);
